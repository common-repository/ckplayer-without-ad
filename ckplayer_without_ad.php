...
播放器风格只为用户更改播放器右上角logo，默认值为"3"，如果您认为我的工作对您有所帮助，欢迎您对我进行捐助。
</p><hr />
...
function ckplayer($atts, $content=null){
	...
	return '<embed src="http://tv.lyre.cn/ck'.get_option('ck_style').'/ckplayer.swf?a='.$content.'" allowFullScreen="true" quality="high" width="'.get_option('ck_width').'" height="'.get_option('ck_height').'" align="middle" allowScriptAccess="always" type="application/x-shockwave-flash">';
}
